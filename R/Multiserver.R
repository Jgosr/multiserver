#' Multiserver 2
#'
#' @param Arrivals Shows the arrival time and each customer
#' @param ServiceTimes Displays the service times of each customer
#' @param NumServers Dispays the number of people to be serviced
#'
#' @return Displays the service time intervals
#' @export
#'
#' @examples
